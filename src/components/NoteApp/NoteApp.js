...
export default class NoteApp extends Component {
    ...
    removeNote(noteId) {
        ...
        // let mainNoteIndex = newNotes.findIndex(note => note.id === noteId)
                            ...
                            <div className="flex row-gt-sm">
                                <div className="flex flex-50-gt-sm">
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mx-auto">
                                        <input id="input-field" className="form-control" type="text" style={{backgroundColor: this.state.inputColor }} placeholder="Something here..." value={this.state.noteTitle} onChange={this.noteTitleHandler}/>
                                    </div>
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mx-auto">
                                        <div id='color-select'>
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mx-auto my-1 text-right">
                                        ...
                                        <button id="btn-delete" type="button" onClick={this.emptyNoteTitle} className="btn btn-outline-danger"><span id="btn-icon"
                                        ...
                                        <div className="row">
                                            <div id='listed' className="col-11 col-sm-11 col-md-11 col-lg-11 col-xl-11 p-3 card-columns">
                                                ...
                                                {this.state.notes.map(note => (
                                                    <Note key={note.title} {...note} onRemove={this.removeNote}/>
                                                ))}
